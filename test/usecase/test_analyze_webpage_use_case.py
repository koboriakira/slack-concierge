...
class TestAnalyzeWebpageUseCase(unittest.TestCase):
    ...
    @patch("slack.usecase.analyze_webpage_use_case.AnalyzeWebpageUseCase._create_video_page")
    def test_handle_youtube(self, mock_create_video_page: Mock) -> None:
        ...
        self.suite.youtube_repository.save_from_attachment.return_value = Youtube(
            ...
            notion_page_url="https://example.com",
        )
        ...
        # Then
        self.assertEqual(actual.page_id, "mock_page_id")
        self.assertEqual(actual.url, "https://example.com")

    @patch("slack.usecase.analyze_webpage_use_case.AnalyzeWebpageUseCase._create_webclip_page")
    def test_handle_twitter(self, mock_create_webclip_page: Mock) -> None:
        ...
        self.suite._create_webclip_page = mock_create_webclip_page
        ...
        # When
        _ = self.suite.handle(original_url=attachment["original_url"], attachment=attachment)
    ...
    @patch("slack.usecase.analyze_webpage_use_case.AnalyzeWebpageUseCase._create_prowrestling_page")
    def test_handle_wrestle_universe(self, mock_create_prowrestling_page: Mock) -> None:
        ...
        self.suite._create_prowrestling_page = mock_create_prowrestling_page
